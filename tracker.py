...
class TrackerApp:
    def __init__(self, master):
        ...
        self.editor_workshop_label = ttk.Label(self.panel_editor, text = "Steam Workshop", cursor = "hand2")
        self.editor_workshop_label.grid(row = 4, column = 2, padx = 5, sticky = "nw")
        self.editor_workshop_variable = tk.StringVar()
        self.editor_workshop_label.bind("<1>", lambda e: self.copy_to_clipboard(self.editor_workshop_variable.get()))
        ...
        self.editor_trucky_label = ttk.Label(self.panel_editor, text = "TruckyMods", cursor = "hand2")
        self.editor_trucky_label.grid(row = 5, column = 2, padx = 5, sticky = "nw")
        self.editor_trucky_variable = tk.StringVar()
        self.editor_trucky_label.bind("<1>", lambda e: self.copy_to_clipboard(self.editor_trucky_variable.get()))
        ...
        self.editor_modland_label = ttk.Label(self.panel_editor, text = "Modland", cursor = "hand2")
        self.editor_modland_label.grid(row = 7, column = 2, padx = 5, sticky = "nw")
        self.editor_modland_variable = tk.StringVar()
        self.editor_modland_label.bind("<1>", lambda e: self.copy_to_clipboard(self.editor_modland_variable.get()))
